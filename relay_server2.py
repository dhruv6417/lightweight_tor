...
def deserialize_payload(payload):
    ...
    DECRYPTED_AES_KEY = crypty.decrypt_rsa(PRIVATE_KEY, encrypted_aes_key)
    next_ip, message = crypty.decrypt_payload(DECRYPTED_AES_KEY, encrypted_message) # decrypted_message = encypted_payload + next_ip
...
def serialize_payload(message):
    ...
    aes_encrypted_message = crypty.encrypt_aes(DECRYPTED_AES_KEY, message)
